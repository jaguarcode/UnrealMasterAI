/**
 * content.findAssets tool handler.
 * Searches for assets in the Content Browser by query string.
 */
...
export async function contentFindAssets(
  ...
  const msg = {
    ...
    params: { script: 'content_find', args: params },
    timestamp: Date.now(),
  };
