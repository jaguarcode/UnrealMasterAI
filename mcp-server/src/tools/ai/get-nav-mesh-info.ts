...
export interface AiGetNavMeshInfoParams {}

export async function aiGetNavMeshInfo(
  bridge: WebSocketBridge,
  params: AiGetNavMeshInfoParams,
): Promise<McpToolResult> {
  const msg = {
    id: uuidv4(),
    method: 'python.execute' as const,
    params: { script: 'ai_get_nav_mesh_info', args: params },
    timestamp: Date.now(),
  };
  try {
