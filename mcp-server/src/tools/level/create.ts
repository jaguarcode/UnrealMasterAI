/**
 * level-create tool handler.
 * Creates a new level in the Unreal project via the Python bridge.
 */
...
export async function levelCreate(
  ...
  const msg = {
    ...
    params: { script: 'level_create', args: params },
    timestamp: Date.now(),
  };
  try {
