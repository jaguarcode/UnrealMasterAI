/**
 * debug.getPerformance tool handler.
...
export interface DebugGetPerformanceParams {}

export async function debugGetPerformance(
  bridge: WebSocketBridge,
  params: DebugGetPerformanceParams,
): Promise<McpToolResult> {
  const msg = {
    id: uuidv4(),
    method: 'python.execute' as const,
    params: { script: 'debug_performance', args: params },
    timestamp: Date.now(),
  };
  try {
