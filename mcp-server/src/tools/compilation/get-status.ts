/**
 * compilation.getStatus tool handler.
 * Gets the current compilation status from Unreal Editor.
 */
...
export async function compilationGetStatus(bridge: WebSocketBridge, params: GetStatusParams) {
  const msg = {
    id: uuidv4(),
    method: 'compilation.getStatus',
