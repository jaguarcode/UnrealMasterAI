...
export interface AnimListSequencesParams {
  skeletonPath?: string;
}

export async function animListSequences(
  bridge: WebSocketBridge,
  params: AnimListSequencesParams,
): Promise<McpToolResult> {
  const msg = {
    id: uuidv4(),
    method: 'python.execute' as const,
    params: { script: 'anim_list_sequences', args: params },
    timestamp: Date.now(),
  };
  try {
